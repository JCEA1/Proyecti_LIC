	...
	*/
	...
	//Solicitud de parametro de busqueda al usuario
		...
		//Comprueba si Busqueda se encuentre en la Matriz
			if(NombresProductos[i].search(Busqueda) > 0){
			...
			document.write("<tr>");
				document.write("<td>Nombre del Producto: " + NombresProductos[i] + "</td>");
				document.write("<td>Sistema del Producto: " + SistemaProductos[i] + "</td>");
				document.write("<td>Accesorios del Producto: " + AccesoriosProductos[i] + "</td>");
				document.write("<td>Precio del Producto: " + PrecioProductos[i] + "</td>");
				document.write("</tr>");
